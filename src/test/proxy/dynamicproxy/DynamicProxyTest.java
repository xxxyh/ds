...
public class DynamicProxyTest {
    public static void main(String[] args) {
        ...
        VIPMovie vipMovieProxy = (VIPMovie) Proxy.newProxyInstance(MyInvocationHandler.class.getClassLoader(), IronManVIPMovie.class.getInterfaces(), handler);
        vipMovieProxy.vipPlay();

        Movie movie = new CaptainAmericaMovie();
        MyInvocationHandler handler1 = new MyInvocationHandler(movie);
        Movie movieProxy = (Movie) Proxy.newProxyInstance(MyInvocationHandler.class.getClassLoader(), CaptainAmericaMovie.class.getInterfaces(), handler1);
        movieProxy.play();
